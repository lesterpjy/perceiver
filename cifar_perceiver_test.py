...
try:
    ...
    from perceiver.data.vision import CIFAR100DataModule
...
def main():
    ...
    data = CIFAR100DataModule(batch_size=batch_size, num_workers=num_workers, pin_memory=config["data"]["pin_memory"])
    logger.info(f"Initialized CIFAR data module with batch_size={batch_size}, num_workers={num_workers}")
